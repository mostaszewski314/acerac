...
# Ant ACER
python3 acer/run.py --algo acer --env_name AntBulletEnv-v0 --gamma 0.99 --lam 0.9 --b 2 --c 10 --critic_lr 1e-5 --actor_layers_mean 256 256  --critic_layers 256 256 --memory_size 1000000 --num_parallel_envs 10 --actor_beta_penalty 0.001 --batches_per_env 10 --num_evaluation_runs 5 --max_time_steps 3000000 --actor_layers_std 64 64 --alpha 0.3 --actor_lr 0.00001 0.00001
